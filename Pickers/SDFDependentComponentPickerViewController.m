//
//  SDFDependentComponentPickerViewController.m
//  Pickers
//
...
#import "SDFDependentComponentPickerViewController.h"


#define kStateComponent 0
#define kZipComponent   1

@interface SDFDependentComponentPickerViewController ()
...
@implementation SDFDependentComponentPickerViewController
...
- (IBAction)buttonPressed:(id)sender {
    ...
    NSString *title = [
                       [NSString alloc]
                       initWithFormat:@"You selected zip code %@.", zip
                       ];
    NSString *message = [
